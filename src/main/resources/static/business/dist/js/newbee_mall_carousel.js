...
$('#saveButton').click(function () {
    ...
    var url = '/business/carousels/save';
    var id = getSelectedRowWithoutAlert();
    if (id != null) {
        url = '/business/carousels/update';
        data = {
            "carouselId": id,
            "carouselUrl": carouselUrl,
            "carouselRank": carouselRank,
...
function carouselEdit() {
    ...
    //请求数据
    $.get("/business/carousels/info/" + id, function (r) {
...
function reset() {
    $("#redirectUrl").val('##');
    $("#carouselRank").val(0);
    $("#carouselImg").attr("src", '/business/dist/img/img-upload.png');
    $("#carouselImg").attr("style", "height: 64px;width: 64px;display:block;");
